...
const RecipeDetailScreen = () => {
        ...
        const checkIfSaved = async () => {
            ...
            try {
                ...
                if (!response.ok) {
                    ...
                    console.error("Save error while fetching favorites", errorText);
                    return; 
                }
    ...
    const handleToggleSave = async () => {
        ...
        try {
            ...
            Alert.alert("Error", `Что-то пошло не так. Повторите попытку.`);
    ...
    if(loading) return <LoadingSpinner message="Загрузка деталей..."/>
            ...
            <View style={recipeDetailStyles.titleSection}>
              ...
              {recipe.area && (
                <View style={recipeDetailStyles.locationRow}>
                  ...
                  <Text style={recipeDetailStyles.locationText}>{recipe.area} Кухня</Text>
                </View>
              )}
            </View>
          </View>
          ...
          <View style={recipeDetailStyles.contentSection}>
            ...
            <View style={recipeDetailStyles.statsContainer}>
              <View style={recipeDetailStyles.statCard}>
                ...
                <Text style={recipeDetailStyles.statLabel}>Время готовки</Text>
              </View>
              ...
              <View style={recipeDetailStyles.statCard}>
                ...
                <Text style={recipeDetailStyles.statLabel}>Порции</Text>
              </View>
            </View>
            ...
            {recipe.youtubeUrl && (
              <View style={recipeDetailStyles.sectionContainer}>
                <View style={recipeDetailStyles.sectionTitleRow}>
                  ...
                  <Text style={recipeDetailStyles.sectionTitle}>Видео туториал</Text>
                </View>
            ...
            <View style={recipeDetailStyles.sectionContainer}>
              <View style={recipeDetailStyles.sectionTitleRow}>
                ...
                <Text style={recipeDetailStyles.sectionTitle}>Ингредиенты</Text>
            ...
            <View style={recipeDetailStyles.sectionContainer}>
              <View style={recipeDetailStyles.sectionTitleRow}>
                ...
                <Text style={recipeDetailStyles.sectionTitle}>Инструкция</Text>
                <View style={recipeDetailStyles.countBadge}>
                  ...
                  <View key={index} style={recipeDetailStyles.instructionCard}>
                    ...
                    <View style={recipeDetailStyles.instructionContent}>
                      ...
                      <View style={recipeDetailStyles.instructionFooter}>
                        <Text style={recipeDetailStyles.stepLabel}>Шаг {index + 1}</Text>
