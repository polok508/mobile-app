...
const SignUpScreen = () => {
    ...
    const handleSignUp = async () => {
        ...
        if(password.length < 6) return Alert.alert("Error", "Пароль должен состоять не менее чем из 6 символов");
        ...
        try {
            ...
            Alert.alert("Error", err.errors?.[0]?.message || "Ошибка при создании аккаунта");
        ...
        <View style={authStyles.container}>
            ...
            style={authStyles.keyboardView}>
                ...
                showsVerticalScrollIndicator={false}>
                    ...
                    <Text style={authStyles.title}>Создайте аккаунт</Text>
                    ...
                    <View style={authStyles.formContainer}>
                        ...
                        onPress={handleSignUp} disabled={loading} activeOpacity={0.8}>
                            <Text style={authStyles.buttonText}>
                                {loading ? "Creating Account" : "Создать"}
                            </Text>
                        </TouchableOpacity>
                        ...
                        onPress={() => router.back()}>
                            <Text style={authStyles.linkText}>
                                Уже есть аккаунт? <Text style={authStyles.link}>Войти</Text>
                            </Text>
                        </TouchableOpacity>
